...
int dwc3_core_init(struct dwc3 *dwc3_reg)
{
	...
	if ((revision & DWC3_GSNPSID_MASK) != 0x55330000 &&
		...
		ZF_LOGE("this is not a DesignWare USB3 DRD Core\n");
		return -1;
	}
	...
	case DWC3_GHWPARAMS1_EN_PWROPT_CLK:
		...
		break;
	default:
		ZF_LOGD("No power optimization available\n");
	}
...
// int xhci_dwc3_probe(uintptr_t usb_regs)
// {
...
// 	hccr = (struct xhci_hccr *)((uintptr_t)usb_regs);
...
// int xhci_dwc3_remove(struct udevice *dev)
// {
// 	struct xhci_dwc3_plat *plat = dev_get_plat(dev);
